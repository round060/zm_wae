...
#From MidFish: A Large-Scale Aggregation of State Fisheries Data from the Midwestern United States from 1940 - 2023 - ScienceBase-Catalog
...
# Remove old objects
```{r}
rm(new_surveys); rm(new_surveys_ais); rm(new_surveys_spatial);
